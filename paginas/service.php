    ...
    <section class="service_section layout_padding">
        ...
        <div class="row">
            ...
            <div class="container layout_padding2">
                ...
                <div class="col-md-4">
                    <div class="img_box">
                    <img src="/Proyecto_mascotas/img/s-1.png" alt="">
                    </div>
                ...
                <div class="col-md-4">
                    <div class="img_box">
                    <img src="/Proyecto_mascotas/img/s-2.png" alt="">
                    </div>
                    <div class="detail_box">
                    <h6>
                        Pet Hotel
                ...
                <div class="col-md-4">
                    <div class="img_box">
                    <img src="/Proyecto_mascotas/img/s-3.png" alt="">
                    </div>
                    <div class="detail_box">
                    <h6>
                        Emergency
            ...
            <div class="col-md-4">
            <img src="/Proyecto_mascotas/img/tool.png" alt="" class="w-100">
            </div>
        </div>
        </div>
    </section>
